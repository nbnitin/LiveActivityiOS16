...
struct ContentView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            {
                Link("(+91)99999999", destination: URL(string: "tel:+9199999999")!)
...
//        }.ignoresSafeArea(.all)
    ...
    func startDeliveryPizza() {
        ...
        let initialContentState = PizzaDeliveryAttributes.PizzaDeliveryStatus(driverName: "\(DRIVER_NAME) 👨🏻‍🍳", estimatedDeliveryTime: Date()...Date().addingTimeInterval(15 * 60))
    ...
    func updateDeliveryPizza() {
        Task {
            let updatedDeliveryStatus = PizzaDeliveryAttributes.PizzaDeliveryStatus(driverName: "\(DRIVER_NAME) 👨🏻‍🍳", estimatedDeliveryTime: Date()...Date().addingTimeInterval(60 * 60))
    ...
    func startPizzaAd() {
        ...
        let initialContentState = PizzaAdAttributes.PizzaAdStatus(adName: "\(DRIVER_NAME) 👨🏻‍🍳 's Pizza Offer", showTime: Date().addingTimeInterval(60 * 60))
        do {
